...
function ProductCard({image, state, title, price, product}) {
  ...
  return (
    <div className="w-72 m-4">
      <div className="relative">
        ...
        <AiOutlinePlusCircle className="w-8 h-8 bg-white rounded-full absolute top-3 right-3 cursor-pointer" onClick={() => {addToCart(product)}}/>
